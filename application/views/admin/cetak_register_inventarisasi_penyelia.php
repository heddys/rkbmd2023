...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <center>
        <h5>
            ...
            <p class="ex2"><?php echo strtoupper($data_kib->unit);?> KOTA SURABAYA</p>
            </b>
        </h5>
    </center>
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th width="25px">:</th>
                <th width="150px"><?php echo $pb_verif->nama_kepala;?></th>
    ...
    <table class="table table-sm table-borderless">
        ...
        <tbody>
            ...
            <tr>
                ...
                <th width="20px"><center>:</center></th>
                <th colspan="4"><?php echo $pb_verif->nama_kepala;?></th>
            </tr>
            <tr>
                <th width="120px"></th>
                <th width="25px"></th>
            ...
            <tr>
                ...
                <th width="25px"></th>
                <th></th>
                <th colspan="4" width="100px" style="text-align: right;"></th>
            </tr>
            <tr>
                <th></th>
                <th></th>
                <th style="text-align: right;" colspan="4"><b>HALAMAN INI DICETAK OLEH PENYELIA</b></th>
                <th></th>
                <th></th>
                <th></th>
            </tr>
