 ...
 $('#modal-xl').on('click', '#tmbahrincian', function(){
  var html='';
    ...
    $('#modal-tambah').modal({backdrop: 'static', keyboard: false});
     ...
     html +=  '<label>Info Register : </label>'+
              '<div class="input-group control-group">'+
                '<span id="register" class="form-control col-md-5">12345678-2012-45575-1</span>&nbsp'+
                '<span id="kondisi" class="form-control col-md-3">Baik</span>'+
              '</div>'+
              '<br><p>'+
              '<span id="vartotal" class="form-control col-md-8">Printer Epson L2000</span>'+
                              '<label>Pemanfaatan Barang : </label>'+
                              '<textarea class="form-control col-md-8" name="pemanfaatan[]" placeholder="Contoh : Untuk Pengetikan Laporan..., Mobil Operasional Kantor..., Untuk Mencetak Laporan" required></textarea>'+
                               '<label>Digunakan Oleh : </label>'+
                               '<textarea class="form-control col-md-8" name="digunakan[]" placeholder="Contoh : Penggunaan Sharing (orang banyak), Bapak Budi Staff IT, Dll.." required></textarea>'+
                               '<label>Posisi Barang : </label>'+
                               '<input type="text" class="form-control col-md-8" name="posisi[]" placeholder="Contoh : Bidang Pendapatan, Bagian Analis, Dll...." required>'+
                               '<label>Keterangan Lanjutan : </label>'+
                               '<textarea class="form-control col-md-8" name="ketlanjut[]"></textarea><hr>'+
              '<label>Info Register : </label>'+
              '<div class="input-group control-group">'+
                '<span id="register" class="form-control col-md-5">12345678-2012-45575-1</span>&nbsp'+
                '<span id="kondisi" class="form-control col-md-3">Baik</span>'+
              '</div>'+
