	            ...
	            <div class="card-body" style="overflow-x:auto;">
                    ...
                    <?php } else {?>
                        ...
                        <tbody>
                            <tr>
                            <td width="70%">
                                <form role="form" action="<?php echo base_url();?>index.php/status_form/verif_page/<?php echo $kib_apa ?>" method="post">
                                <div class="col-md-5">
                        ...
                        <tbody>
                            <?php $x=$offset+1; foreach ($register as $row) {?>
                                <tr>
                                    ...
                                    <td>  
                                        <form role="form" action="<?php echo site_url();?>/status_form/cetak_form_<?php echo $kib_apa; ?>" method="post" target="_blank" >
                                            <center>
                                            <button type="submit" class="btn btn-sm btn-success" title="Isi Form Inventarisasi"><i class="fa fa-print"></i>
                        ...
                        <form role="form" action="<?php echo site_url();?>/status_form/verif_page/<?php echo $kib_apa ?>" method="post">
