                                ...
                                <label><h5><b>Upload Foto atau Denah Aset</b></h5></label>
                                    <div class="mb-3">
                                        <?php foreach ($image as $i) {?>
                                            ...
                                            <iframe src="<?php echo base_url();?>/ini_assets/upload/<?php echo $i->file_upload?>" frameborder="0" width="120%" height="800px"></iframe>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
                 ...
                 <div class="modal-body">
	                ...
	                <center><div class="form-group col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="penolakan" rows="3" ></textarea>
                                    </div>
                            </div></center>
	             </div>
