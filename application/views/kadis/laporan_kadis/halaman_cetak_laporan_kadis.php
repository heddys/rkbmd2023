                      ...
                      <div class="card card-primary">
                        ...
                        <div id="menu1" class="panel-collapse collapse in">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/cetak_perubahan_data_barang');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
                      ...
                      <div class="card card-danger">
                        ...
                        <div id="menu2" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/cetak_form_kondisi_barang');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="<?php echo site_url('home_kadis/cetak_form_kondisi_barang/1.3.01');?>" target="_blank" rel="noopener noreferrer" class="btn btn-block btn-outline-primary">Tanah</a>
                                    </th>
                                    <th>
                      ...
                      <div class="card card-success">
                        ...
                        <div id="menu3" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/cetak_barang_tidak_ditemukan');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="<?php echo site_url('home_kadis/cetak_barang_tidak_ditemukan/1.3.01');?>" target="_blank" rel="noopener noreferrer" class="btn btn-block btn-outline-primary">Tanah</a>
                                    </th>
                                    <th>
                      ...
                      <div class="card card-info">
                        ...
                        <div id="menu4" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/laporan_barang_hilang');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="<?php echo site_url('home_kadis/laporan_barang_hilang/1.3.01');?>" target="_blank" rel="noopener noreferrer" class="btn btn-block btn-outline-primary">Tanah</a>
                                    </th>
                                    <th>
                      ...
                      <div class="card card-warning">
                        ...
                        <div id="menu5" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/laporan_belum_dikapt_diketahui_induk');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="<?php echo site_url('home_kadis/laporan_belum_dikapt_diketahui_induk/1.3.01');?>" target="_blank" rel="noopener noreferrer" class="btn btn-block btn-outline-primary">Tanah</a>
                                    </th>
                                    <th>
                      ...
                      <div class="card card-secondary">
                        ...
                        <div id="menu6" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/laporan_belum_dikapt_tidak_diketahui_induk');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="<?php echo site_url('home_kadis/laporan_belum_dikapt_tidak_diketahui_induk/1.3.01');?>" target="_blank" rel="noopener noreferrer" class="btn btn-block btn-outline-primary">Tanah</a>
                                    </th>
                                    <th>
                        ...
                        <div id="menu7" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="<?php echo site_url('home_kadis/laporan_data_tercatat_ganda/1.3.01');?>" target="_blank" rel="noopener noreferrer" class="btn btn-block btn-outline-primary">Tanah</a>
                                    </th>
                                    <th>
                      ...
                      <div class="card card-success">
                        ...
                        <div id="menu8" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/laporan_data_digunakan_pihak_lain');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
                                        <a href="<?php echo site_url('home_kadis/laporan_data_digunakan_pihak_lain/1.3.01');?>" target="_blank" rel="noopener noreferrer" class="btn btn-block btn-outline-primary">Tanah</a>
                                    </th>
                                    <th>
                      ...
                      <div class="card card-secondary">
                        ...
                        <div id="menu9" class="panel-collapse collapse">
                          <div class="card-body">
                            ...
                            <hr>
                            <!-- <a href="<?php echo site_url('home_kadis/laporan_data_digunakan_pegawai_pemda');?>" target="_blank" rel="noopener noreferrer" class="btn btn-default btn-block btn-flat">Cetak Laporan</a> -->
                            <table class="table">
                                <tr>
                                    <th>
