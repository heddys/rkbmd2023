...
<table style="font-size : 12px;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="25px">:</td>
                <td width="150px">LILIK ARIJANTO, S.T, M.T</td>
            </tr>
        </tbody>
</table>
<hr>
...
<table style="width: 100%; border:1px solid; border-collapse: collapse; font-size:11px;">
    ...
    <!-- Isi Datanya -->
        ...
        <?php $x++; $jumlah+=$row->nilai_perolehan;}} else {?>
            <tr style="border:1px solid">
                <td style="border:1px solid; text-align: center; vertical-align: middle;" colspan="21"><b>N I H I L</b></td>
            </tr>
            <?php } ?>
    <tr>
