...
<script>
  ...
  function rupiah (angka){
    ...
    function klik_reg_tanah(x){
      if(x == true){
        var isi_text = document.querySelector("#modal-register-tanah [id=status_tanah]").value;
        
        if(isi_text == 1 ) {
          
          var id = "reg_tanah";
            $('#modal-list-register3').modal({backdrop: 'static', keyboard: false});
            function rupiah (angka){
                      var reverse = angka.toString().split('').reverse().join(''),
                      ribuan = reverse.match(/\d{1,3}/g);
                      ribuan = ribuan.join('.').split('').reverse().join('');
            ...
            $.ajax({
              ...
              success: function(data){
                  ...
                  var x=1;
                    ...
                    $('#modal-list-register3').find('#tblregister3').DataTable();
    ...
    function klik_destroy3() {
      $('#tblregister3').DataTable().destroy();
      $('#modal-list-register3').modal('hide');
      $("input:radio[id=primary38]:checked")[0].checked = false;
    }
    ...
    $('#modal-list-register3').on('click', '.ambil_register3', function(){
      var idku=$(this).attr('data-id');
      $('#tblregister3').DataTable().destroy();
      $('#modal-list-register3').modal('hide');
      document.getElementById('register_tanah').value=idku;
    });
...
function formatCurrency(input, blur) {
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    //   } else {
    //     $("input:radio[id=primaryperkerasan2]:checked")[0].checked = false;
    //   }
    // }

    function klik_perkerasan(id){
      if(id == true){
        var isi_text = document.querySelector("#modal-perkerasan [id=jenis_perkerasan]").value;
        document.getElementById('perkerasan').value=isi_text;
      } else {
        $("input:radio[id=primaryperkerasan2]:checked")[0].checked = false;
      }
    }

    function klik_jembatan(id){
      if(id == true){
        var isi_text = document.querySelector("#modal-jenis_jembatan [id=bahan_jembatan]").value;
        document.getElementById('struktur_jembatan').value=isi_text;
      } else {
        $("input:radio[id=jenis_jembatan2]:checked")[0].checked = false;
      }
    }

    function klik_ruas(id){
      if(id == true){
        var nama_ruas = document.querySelector("#modal-ruas_jalan [id=input_ruas]").value;
        var ujung_ruas = document.querySelector("#modal-ruas_jalan [id=input_ujung]").value;
        var pangkal_ruas = document.querySelector("#modal-ruas_jalan [id=input_pangkal]").value;
        document.getElementById('nama_ruas').value=nama_ruas;
        document.getElementById('ujung_ruas').value=ujung_ruas;
        document.getElementById('pangkal_ruas').value=pangkal_ruas;
      } else {
        $("input:radio[id=radio_ruas_jalan2]:checked")[0].checked = false;
      }
    }

    function klik_no_irigasi(id){
      if(id == true){
        var isi_text = document.querySelector("#modal-nomor_irigasi [id=input_nomor_irigasi]").value;
        document.getElementById('nomor_irigasi').value=isi_text;
      } else {
        $("input:radio[id=primary_nomor_irigasi2]:checked")[0].checked = false;
      }
    }
    ...
    $(document).ready(function () {
      ...
      $('#primary38').click(function () {
          if ($(this).is(':checked')) {
              $('#modal-register-tanah').modal({backdrop: 'static', keyboard: false});
          }  
      });

      $('#primaryperkerasan2').click(function () {
          if ($(this).is(':checked')) {
              $('#modal-perkerasan').modal({backdrop: 'static', keyboard: false});
          }  
      });

      $('#jenis_jembatan2').click(function () {
          if ($(this).is(':checked')) {
              $('#modal-jenis_jembatan').modal({backdrop: 'static', keyboard: false});
          }  
      });

      $('#radio_ruas_jalan2').click(function () {
          if ($(this).is(':checked')) {
              $('#modal-ruas_jalan').modal({backdrop: 'static', keyboard: false});
          }  
      });
      
      $('#primary_nomor_irigasi2').click(function () {
          if ($(this).is(':checked')) {
              $('#modal-nomor_irigasi').modal({backdrop: 'static', keyboard: false});
          }  
      });
