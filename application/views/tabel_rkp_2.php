          ...
          <hr>
        	<div class="card">
	            <div class="card-header">
	              <h3 class="card-title"><center>Tabel Rencana Kebutuhan Barang Persediaan</center></h3>
	            </div>
	            <!-- /.card-header -->
	            <div class="card-body" style="overflow-x:auto;">
	              <table id="example1" class="table table-bordered table-hover">
	                ...
	                <tbody>
	               		<?php $x=1;
	                foreach ($datarkp->result() as $row) {?>
	                <tr>
	                  <td><center><?php echo $x;?></center></td>
	                  <td><center><?php echo $row->rekening_kode;?></center></td>
	                  <td><?php echo $row->komp_name;?></td>
	                  <td><?php echo $row->ket_koefisien;?></td>
	                  <td><?php echo number_format($row->nilai_anggaran,2,',','.');?></td>
	                  <td><?php echo $row->detail_name;?></td>
	                  <td>
	                  	<center>
	                  		<a href="javascript:;" class="btn btn-sm btn-success rincian_kegiatan"><i class="fa fa-fw fa-search-plus"></i></a>
                    	</center>
                      </td>
	                </tr>
	            	<?php $x++; }?>
