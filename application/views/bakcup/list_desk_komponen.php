                    ...
                    <div class="card-header">
      				    ...
      				    <form role="form" action="saverincianexist" method="post">
      				      <div class="form-group form_input">
      				    	<label>Input Register : </label>
      	                	<div class="input-group control-group">
                                <span type="text" class="form-control col-md-5" id="reg1"></span>
                                	&nbsp<a href="#" class="btn btn-primary btn-flat carireg col-md-2">Pilih Register </a>
                               </div>
                               <br>
                               <input type="hidden" id="regsave" name="regsave">
                               <input type="hidden" id="idsementara" name="idsementara">
                               <label>Kondisi Barang : </label>
                               <select class="form-control col-md-7" id="kondisi" name="kondisi" required>
      	                          <option></option>
                               ...
                               <textarea class="form-control col-md-7" name="pemanfaatan" placeholder="Contoh : Untuk Pengetikan Laporan..., Mobil Operasional Kantor..., Untuk Mencetak Laporan" required></textarea>
                               <br>
                               <label>Digunakan Oleh : </label>
                               <textarea class="form-control col-md-7" name="digunakan" placeholder="Contoh : Penggunaan Sharing (orang banyak), Bapak Budi Staff IT, Dll.." required></textarea>
                               <br>
                               <label>Keterangan Lanjutan : </label>
                               <textarea class="form-control col-md-7" name="ketlanjut"></textarea>
                             </div>   
      	                   <div class="modal-footer ">
