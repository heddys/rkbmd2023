  ...
  <nav class="main-header navbar navbar-expand border-bottom navbar-dark navbar-cyan">
    ...
    <ul class="navbar-nav">
      ...
      <li class="navbar-item">
        ...
        <!--UNTUK NAMA DINASNYA-->
        <strong class="nav-link fontku"><font color="white">Pemeriksa / Auditor</font></strong>
      </li>
    </ul>
    <!-- Right navbar links -->
    <ul class="navbar-nav ml-auto fontku">
          <strong><u>BPK RI</u></strong> 
    </ul>
      ...
      <nav class="mt-2">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column fontside" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-open">
            <a href="<?php echo site_url('home_guest');?>" class="nav-link active">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo site_url('home_guest/cari_register/1');?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Tanah</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('home_guest/cari_register/2')?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
                  <p>Peralatan Mesin</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo site_url('home_guest/cari_register/3');?>" class="nav-link">
                  <i class="nav-icon fas fa-arrow-alt-circle-right"></i>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo site_url('home_guest/halaman_laporan');?>" class="nav-link">
        ...
        <div class="row mb-1">
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="<?php echo site_url('home_guest');?>">Home</a></li>
