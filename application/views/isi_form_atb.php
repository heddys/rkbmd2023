<section class="content">
            ...
            <!-- general form elements disabled -->
              <div class="card card-dark">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form role="form" action="save_isi_form_atb" method="post" enctype="multipart/form-data">
                        <!-- select -->
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-8">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control" name="lainnya" id="kode_register" placeholder="Tulis Masa Aktif Lisensi atau Keterangan Tambahan Tentang Aplikasi">
                                    </div>
                            </div>
                            ...
                            <div class="form-group col-md-8 file_upload">
                                <div class="mb-3">
                                <label><h5><b>Upload Screenshot Aplikasi atau Foto Product Lisensi</b></h5></label> (Tipe Gambar : .jpeg |.jpg | .png , Ukuran File Max : 5MB)
