        	...
        	<div class="card">
				...
				<table>
                  ...
                  <tbody>
                    <tr>
                      <td width="70%">
                        <form role="form" action="<?php echo base_url();?>index.php/home_verifikator/verif_page" method="post">
                          <div class="col-md-5">
                ...
                <form role="form" action="<?php echo site_url();?>/home_verifikator/verif_page" method="post">
