          ...
          <hr>
        	<div class="card">
	            <div class="card-header">
	              <h3 class="card-title">
                      <center>LIST REGISTER YANG HARUS DI VERIFIKASI - <?php if ($kib_apa == 1) { 
				...
				<table>
                  ...
                  <tbody>
                    <tr>
                      <td width="70%">
                        <form role="form" action="<?php echo base_url();?>index.php/home_verifikator/verif_page/<?php echo $kib_apa; ?>" method="post">
                          <div class="col-md-5">
                            <select class="form-control select_lokasi" id="select_lokasi" name="select_lokasi">
                ...
                <form role="form" action="<?php echo site_url();?>/home_verifikator/verif_page/<?php echo $kib_apa; ?>" method="post">
