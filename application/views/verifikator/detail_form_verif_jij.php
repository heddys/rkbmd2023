                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control" name="alamat" disabled="disabled" value="<?php echo $data_register->nomor_lokasi_awal." - ".$data_register->nama_lokasi;?>" >
                                    </div>
                            </div>
                            <!-- /.col-lg-6 -->
                            <div class=" mt-2 mb-6 col-lg-2">
                            ...
                            <div class="form-group col-md-5 ">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="perkerasan" id="perkerasan" readonly="true" value="<?php echo $data_register->jenis_perkerasan_jalan;?>">
                                    </div>
                            </div>
                            <!-- /.col-lg-6 -->
                            <div class=" mt-2 mb-6 col-lg-4">
                                <div class="form-group clearfix">
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="primary27" name="radio_perkerasan" <?php 
                                                if ($data_is_register->is_perkerasan == 0) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?> value="0"/>
                                        <label for="primary27">Sesuai</label>
                                    </div>
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="primary28" name="radio_perkerasan" <?php 
                                                if ($data_is_register->is_perkerasan == 1) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?> value="1"/>
                            ...
                            <div class="form-group col-md-5 ">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" name="struktur_jembatan" id="struktur_jembatan" readonly="true" value="<?php echo $data_register->jenis_bahan_jembatan;?>">
                                </div>
                            </div>
                            <!-- /.col-lg-6 -->
                            <div class=" mt-2 mb-6 col-lg-4">
                                <div class="form-group clearfix">
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="jenis_jembatan1" name="radio_jembatan" value="0" <?php 
                                                if ($data_is_register->is_struktur_jembatan == 0) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?>/>
                                        <label for="jenis_jembatan1">Sesuai</label>
                                    </div>
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="jenis_jembatan2" name="radio_jembatan" value="1" <?php 
                                                if ($data_is_register->is_struktur_jembatan == 1) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?>/>
                            ...
                            <div class="form-group col-md-6 ">
                                <div class="input-group mb-3">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <input type="text" class="form-control" name="nama_ruas" id="nama_ruas" placeholder="Nama / Nomor Ruas" readonly="true" value="<?php echo $data_register->no_nama_ruas;?>">
                                        </div>
                                        <div class="col-4">
                                            <input type="text" class="form-control" name="ujung_ruas" id="ujung_ruas" placeholder="Nama Ujung Ruas" readonly="true" value="<?php echo $data_register->ujung_ruas;?>">
                                        </div>
                                        <div class="col-4">
                                            <input type="text" class="form-control" name="pangkal_ruas" id="pangkal_ruas" placeholder="Nama Pangkal Ruas" readonly="true" value="<?php echo $data_register->pangkal_ruas;?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class=" mt-2 mb-6 col-md-2">
                                <div class="form-group clearfix">
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="radio_ruas_jalan1" name="radio_ruas_jalan" value="0" <?php 
                                                if ($data_is_register->is_ruas_jalan == 0) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?>/>
                                        <label for="radio_ruas_jalan1">Sesuai</label>
                                    </div>
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="radio_ruas_jalan2" name="radio_ruas_jalan" value="1" <?php 
                                                if ($data_is_register->is_ruas_jalan == 1) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?>/>
                            ...
                            <div class="form-group col-md-5">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" id="basic-addon3">Luas JIJ (m2) :</label>
                                        </div>
                            ...
                            <div class="form-group col-md-5">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control" name="nomor_irigasi" id="nomor_irigasi" readonly="true" value="<?php echo $data_register->no_jaringan_irigasi;?>">
                                    </div>
                            </div>
                            <!-- /.col-lg-6 -->
                            <div class=" mt-2 mb-6 col-lg-4">
                                <div class="form-group clearfix">
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="primary_nomor_irigasi1" name="radio_nomor_irigasi" value="0" <?php 
                                                if ($data_is_register->is_no_jaringan == 0) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?>/>
                                        <label for="primary_nomor_irigasi1">Sesuai</label>
                                    </div>
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="primary_nomor_irigasi2" name="radio_nomor_irigasi" value="1" <?php 
                                                if ($data_is_register->is_no_jaringan == 1) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?>/>
