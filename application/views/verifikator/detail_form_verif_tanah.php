                            ...
                            <div class="form-group col-md-5">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            ...
                                            <input type="text" class="form-control" name="nopol" id="nopol" style="text-transform:uppercase" readonly="true" value="<?php echo $data_register->no_sertifikat;?>">
                                    </div>
                            </div>
                            <!-- /.col-lg-6 -->
                            <div class=" mt-2 mb-6 col-lg-4">
                                <div class="form-group clearfix">
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="primary25" name="radio_nopol" <?php 
                                                if ($data_is_register->is_no_sertif == 0) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?> value="0" />
                                        <label for="primary25">Sesuai</label>
                                    </div>
                                    <div class="radio icheck-primary d-inline">
                                        <input type="radio" id="primary26" name="radio_nopol" <?php 
                                                if ($data_is_register->is_no_sertif == 1) { echo "checked='checked'";} else {echo "disabled='disabled'";}
                                            ?> value="1"/>
