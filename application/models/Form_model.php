 ...
 class Form_model extends CI_Model{
    ...
    public function __construct() {
            ...
            public function get_kib_for_excel($lokasi,$kib)
            {
                ...
                // $query = $this->db->query("SELECT a.register,b.lokasi,a.status,a.kode_barang,a.nama_barang,a.spesifikasi_barang_merk,a.nilai_perolehan,a.tipe,a.tahun,DATE_FORMAT(a.created_date, '%m/%e/%Y') as tanggal FROM `rkbmd2023`.register_isi a inner join `2025_v1`.kamus_lokasi b on a.nomor_lokasi_awal = b.nomor_lokasi WHERE a.hapus <> 1 and a.extrakomtabel <> 1 and left(a.nomor_lokasi_awal,12) like '".$lokasi."%' and kode_barang like '".$kib."%' group by a.register order by a.status DESC");
            ...
            public function get_all_register($status,$lokasi,$kib=''){
                    ...
                    FROM
                        ...
                        inner join `2025_v1`.kamus_lokasi b ON b.nomor_lokasi = a.nomor_lokasi_awal 
                    WHERE
                        a.status = '".$status."'
            ...
            public function hitungBanyakRowRegister($data,$kib,$form)
            {
                    ...
                    if($form == 2){
                        $no_lokasi=$this->session->userdata('no_lokasi_asli');
                        $query = $this->db->query("SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi_baru,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru,'SALDO AWAL' as status_register FROM `2025_v1`.`kib_awal` a inner join `2025_v1`.kamus_lokasi b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus = '' and a.kode64_baru like '".$kib."%' and a.`nomor_lokasi_baru` like '".$no_lokasi."%' and (a.`register` like '%".$data."%' or a.nama_barang_baru like '%".$data."%') and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register) union SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi_baru,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru,'PENAMBAHAN' as status_register FROM `2025_v1`.`kib` a inner join `2025_v1`.kamus_lokasi b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus = '' and a.kode64_baru like '".$kib."%' and a.`nomor_lokasi_baru` like '".$no_lokasi."%' and (a.`register` like '%".$data."%' or a.nama_barang_baru like '%".$data."%') and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register)");
            ...
            public function hitungBanyakRowRegisterCount($data,$kib,$form,$no_lokasi_asli)
            {
                if($form == 2){
                    $no_lokasi = $no_lokasi_asli;
                    $query = $this->db->query("SELECT count(*) as total FROM (SELECT a.register FROM `2025_v1`.`kib_awal` a inner join `2025_v1`.kamus_lokasi b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus = '' and a.kode64_baru like '".$kib."%' and a.`nomor_lokasi_baru` like '".$no_lokasi."%' and (a.`register` like '%".$data."%' or a.nama_barang_baru like '%".$data."%') and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register) union SELECT a.register FROM `2025_v1`.`kib` a inner join `2025_v1`.kamus_lokasi b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus = '' and a.kode64_baru like '".$kib."%' and a.`nomor_lokasi_baru` like '".$no_lokasi."%' and (a.`register` like '%".$data."%' or a.nama_barang_baru like '%".$data."%') and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register)) as t");
        
                } else {
                    $query = $this->db->query("SELECT count(*) as total FROM (SELECT a.register FROM `2025_v1`.`kib_awal` a inner join `2025_v1`.`kamus_lokasi` b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus = '' and a.kode64_baru like '".$kib."%' and a.`nomor_lokasi_baru` like '".$data."%' and not EXISTS (select x.register from register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from register_isi y where a.register=y.register) union SELECT a.register FROM `2025_v1`.`kib` a inner join `2025_v1`.`kamus_lokasi` b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus = '' and a.kode64_baru like '".$kib."%' and a.`nomor_lokasi_baru` like '".$data."%' and not EXISTS (select x.register from register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from register_isi y where a.register=y.register)) as t");
                }
            ...
            public function hitungBanyakRowRegister_tolak_proses($data,$kib,$form)
            {
                    ...
                    if($form == 2) {
                        $no_lokasi=$this->session->userdata('no_lokasi_asli');
                        $query = $this->db->query("SELECT a.register,a.lokasi,a.kode_neraca as kode64_baru,a.nama_barang,a.spesifikasi_barang_merk as merk_alamat,a.tipe,a.tahun as tahun_pengadaan,a.nilai_perolehan as harga_baru,a.status,b.lokasi as lokasi_pd FROM `rkbmd2023`.register_isi a inner join `2025_v1`.kamus_lokasi b on a.lokasi = b.nomor_lokasi WHERE a.status <> '2' and a.hapus <> 1 and extrakomtabel <> 1 and a.lokasi like '".$no_lokasi."%' and a.kode_barang like '".$kib."%' and (a.register like '%".$data."%' or a.nama_barang like '%".$data."%' or a.spesifikasi_barang_merk like '%".$data."%')");
                    } else {
                        $query = $this->db->query("SELECT a.register,a.lokasi,a.kode_neraca as kode64_baru,a.nama_barang,a.spesifikasi_barang_merk as merk_alamat,a.tipe,a.tahun as tahun_pengadaan,a.nilai_perolehan as harga_baru,a.status,b.lokasi as lokasi_pd FROM `rkbmd2023`.register_isi a inner join `2025_v1`.kamus_lokasi b on a.lokasi = b.nomor_lokasi WHERE a.status <> '2' and a.hapus <> 1 and extrakomtabel <> 1 and a.lokasi like '".$data."%' and a.kode_barang like '".$kib."%'");
                    }
            ...
            public function get_all_register_pagination_verifikator($data,$kib, $limit, $offset,$form){
                ...
                if($form == 2){
                    $no_lokasi=$this->session->userdata('no_lokasi_asli');
                    $query = $this->db->query("SELECT a.register,a.kode_barang_lama as kode64_baru,a.nomor_lokasi_awal as nomor_lokasi,a.nama_barang,a.spesifikasi_barang_merk as merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun as tahun_pengadaan,a.nilai_perolehan as harga_baru FROM `rkbmd2023`.`register_isi` a inner join `2025_v1`.kamus_lokasi b on a.nomor_lokasi_awal=b.nomor_lokasi where a.`status` = 1 and a.hapus <> 1 and a.extrakomtabel <> 1 and a.kode_barang_lama like '".$kib."%' and a.`nomor_lokasi_awal` like '".$no_lokasi."%' and (a.`register` like '%".$data."%' or a.nama_barang like '%".$data."%') limit ".$limit." offset ".$offset."");
                } else {
            ...
            public function get_all_register_pagination_Pbp($kib,$no_lokasi){
                ...
                if(count($no_lokasi) == 1) {
                    $query=$simbadadb->query("SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi_baru,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru, 'SALDO AWAL' as status_register FROM `2025_v1`.`kib_awal` a inner join `2025_v1`.`kamus_lokasi` b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus <> 1 and a.kode64_baru like '".$kib."%' and a.nomor_lokasi_baru like '".$no_lokasi[0]."%' and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register) union SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi_baru,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru,'PENAMBAHAN' as status_register FROM `2025_v1`.`kib` a inner join `2025_v1`.`kamus_lokasi` b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus <> 1 and a.kode64_baru like '".$kib."%' and a.nomor_lokasi_baru like '".$no_lokasi[0]."%' and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register)");
                } else {
                    $query=$simbadadb->query("SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi_baru,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru, 'SALDO AWAL' as status_register FROM `2025_v1`.`kib_awal` a inner join `2025_v1`.`kamus_lokasi` b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus <> 1 and a.kode64_baru like '".$kib."%' and left(a.nomor_lokasi_baru,18) IN ( '".implode("','",$no_lokasi)."' ) and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register) union SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi_baru,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru,'PENAMBAHAN' as status_register FROM `2025_v1`.`kib` a inner join `2025_v1`.`kamus_lokasi` b on a.nomor_lokasi_baru=b.nomor_lokasi where a.extrakomtabel_baru = '' and a.hapus <> 1 and a.kode64_baru like '".$kib."%' and left(a.nomor_lokasi_baru,18) IN ( '".implode("','",$no_lokasi)."' ) and not EXISTS (select x.register from `rkbmd2023`.register_tambak x where x.register=a.register) and NOT EXISTS (SELECT y.register from `rkbmd2023`.register_isi y where a.register=y.register)");
                }
            ...
            public function get_verif_register_pagination_Pbp($kib,$no_lokasi)
            {
                ...
                if(count($no_lokasi) == 1) {
                    $query=$this->db->query("SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru FROM `data_kib` a inner join kamus_lokasi b on a.nomor_lokasi=b.nomor_lokasi where (a.ekstrakomtabel is NULL and a.status_simbada is null and  a.`status` = 2 and a.kode108_baru like '".$kib."%' and a.nomor_lokasi like '".$no_lokasi[0]."%') and not EXISTS (select x.kode_sub_kelompok from kamus_barang x where x.kode_sub_kelompok=left(a.kode108_baru,14) and x.kunci = 1) ");
                } else {
                    $query=$this->db->query("SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru FROM `data_kib` a inner join kamus_lokasi b on a.nomor_lokasi=b.nomor_lokasi where (a.ekstrakomtabel is NULL and a.status_simbada is null and  a.`status` = 2 and a.kode108_baru like '".$kib."%' and left(a.nomor_lokasi,18) IN ( '".implode("','",$no_lokasi)."' )) and not EXISTS (select x.kode_sub_kelompok from kamus_barang x where x.kode_sub_kelompok=left(a.kode108_baru,14) and x.kunci = 1) ");
                }
            ...
            public function get_tolak_register_pagination_Pbp($kib,$no_lokasi)
            {
                ...
                if(count($no_lokasi) == 1) {
                    $query=$this->db->query("SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru,a.status FROM `data_kib` a inner join kamus_lokasi b on a.nomor_lokasi=b.nomor_lokasi where a.ekstrakomtabel is NULL and a.status_simbada is null and a.kode108_baru like '%".$kib."%' and (a.status = '1' or a.status = '3') and left(a.nomor_lokasi,18) = '".$no_lokasi[0]."' and not EXISTS (select x.kode_sub_kelompok from kamus_barang x where x.kode_sub_kelompok=left(a.kode108_baru,14) and x.kunci = 1) order by a.status DESC");
                } else {
                    $query=$this->db->query("SELECT a.register,a.kode64_baru,a.kode108_baru,a.nomor_lokasi,a.nama_barang,a.merk_alamat,a.tipe,b.lokasi,a.satuan,a.tahun_pengadaan,a.harga_baru,a.status FROM `data_kib` a inner join kamus_lokasi b on a.nomor_lokasi=b.nomor_lokasi where a.ekstrakomtabel is NULL and a.status_simbada is null and a.kode108_baru like '%".$kib."%' and (a.status = '1' or a.status = '3') and left(a.nomor_lokasi,18) IN ( '".implode("','",$no_lokasi)."' ) and not EXISTS (select x.kode_sub_kelompok from kamus_barang x where x.kode_sub_kelompok=left(a.kode108_baru,14) and x.kunci = 1) order by a.status DESC");
                }
            ...
            public function ambil_register_form($register)
            {
                ...
                $query = $this->db->query("SELECT a.*,b.kode_binprog,b.nomor_lokasi,b.unit,b.lokasi as nama_lokasi,c.lokasi as nama_lokasi_awal FROM `rkbmd2023`.`register_isi` a left join `2026`.kamus_lokasi b on a.lokasi=b.nomor_lokasi left join kamus_lokasi c on a.nomor_lokasi_awal = c.nomor_lokasi where a.register = '".$register."' order by created_date DESC, created_time DESC");
                return $query;
            }
